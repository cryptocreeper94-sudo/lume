...
export const presentationScenes = [
  ...
  // ── ACT 5: ECOSYSTEM ────────────────────────────
  {
    ...
    content: {
      features: [
        ...
        { icon: 'Shield', title: 'DarkWave Verified', description: 'Meets DarkWave Studios quality standards: CI-verified tests, security scanning, and audit trails.' },
      ],
    },
  },
  {
  ...
  // ── ACT 6: BY THE NUMBERS ────────────────────────────
  {
    ...
    subtitle: 'CI-verified tests. Zero failures.',
  ...
  },
  {
    ...
    narration: 'Lume is production-ready and enterprise-verified. CI-verified tests. Zero failures. Security scanning. Blockchain audit trails. MIT licensed for maximum flexibility.',
